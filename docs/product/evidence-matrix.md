...
| Codex exec evidence | fixture schema/tooling executable; real downstream `codex exec --json` pack captured; metadata parse fix rechecked in smoke 002 | `docs/specs/codex-exec-evidence-pack.md`, `docs/specs/codex-exec-metrics.schema.json`, `docs/evidence/codex-exec-runs/fixture-runtime-skill-smoke-001/`, `docs/evidence/codex-exec-runs/2026-06-17-downstream-basic-real-smoke-001/`, `docs/evidence/codex-exec-runs/2026-06-17-downstream-basic-real-smoke-002/` | eval and evidence tests | `pnpm test`, `pnpm --silent krn eval`, `codex exec --sandbox workspace-write --json` smoke 002 | raw JSONL is not committed; production proof remains false; hook trust remains unproven; automatic skill discovery remains unproven | non-bypass hook trust probe or implicit skill-loading proof |
