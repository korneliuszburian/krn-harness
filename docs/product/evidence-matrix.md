...
| Codex exec evidence | fixture schema/tooling executable; first real downstream `codex exec --json` pack captured | `docs/specs/codex-exec-evidence-pack.md`, `docs/specs/codex-exec-metrics.schema.json`, `docs/evidence/codex-exec-runs/fixture-runtime-skill-smoke-001/`, `docs/evidence/codex-exec-runs/2026-06-17-downstream-basic-real-smoke-001/` | eval and evidence tests | `pnpm test`, `pnpm --silent krn eval` | raw JSONL is not committed; production proof remains false; hook trust remains unproven; installed hook/skill metadata has real Codex parse/load friction | fix installed hook JSON marker and runtime skill frontmatter placement |
