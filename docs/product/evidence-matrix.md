...
| Codex exec evidence | fixture schema/tooling executable; real run evidence absent | `docs/specs/codex-exec-evidence-pack.md`, `docs/specs/codex-exec-metrics.schema.json`, `docs/evidence/codex-exec-runs/fixture-runtime-skill-smoke-001/` | eval and evidence tests | `pnpm test`, `pnpm --silent krn eval` | fixture pack only; raw JSONL is not committed; no production proof or hook trust proof | run first real downstream `codex exec --json` in disposable target and commit sanitized pack only |
