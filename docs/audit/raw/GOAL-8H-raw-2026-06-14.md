...
>
> This is not the active KRN Harness goal, not active product truth, and not the
> current roadmap. Current active goal pointer: `GOAL.md`. Condensed GOAL-8H
> state lives in `docs/product/goal-8h-roadmap.md`.
